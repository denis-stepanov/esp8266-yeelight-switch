 ...
 * 1 long blink - Wi-Fi disconnected.
 ...
 1. Software:
    ...
    1. ESP8266 core for Arduino, https://github.com/esp8266/Arduino (version tested: 2.6.2);
    1. WiFiManager library for Arduino, https://github.com/tzapu/WiFiManager (version tested: 0.15.0-beta; earlier will not work with ESP8266 core 2.6).
